...
## Getting Started
Download GooeyJS.v2.7.0.zip and unzip to your codebase. To include GooeyJS, just use the following:

    <script type="module" src="GooeyJS/src/GooeyJS.js"></script>


**Copyright&copy; 2026 NetHaven Inc.**
